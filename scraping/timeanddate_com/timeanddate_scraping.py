...
### !need a date (and hour) for every row of c !
def scrape(file):
    ...
    if 'extended' in soup.title.string:
        ...
        #a = tds[1].text
            ...
            if len(c)>17:
                ...
                rain = 0
            wind = round(c[7]*1000/3600.,1) #in [m/s]
    ...
    ## get the hourly data
        ...
        for tr in soup.find_all('tr')[2:-1]:
            ...
            # c[9] - humidity
            # c[10] - rain chance
            wind = round(c[6] * 1000 / 3600., 1) #wind in m/s

    return c

if __name__ == '__main__':
    file = "time_and_date_26-04-2016_berlin_daily.html"
    scrape(file)
